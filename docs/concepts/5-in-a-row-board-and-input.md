...
The selected piece uses scale and a hueless dark lift, not a brand-accent halo. This keeps selection readable across motif themes whose dominant colours vary.
...
- [../architecture/decisions/0004-renderer-pick-svg.md](../architecture/decisions/0004-renderer-pick-svg.md) - renderer choice and zero-rAF contract.
